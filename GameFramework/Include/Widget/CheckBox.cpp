			...
			if (m_Texture->GetEnableColorKey())
			{
				if (m_Clicked == true)
				{
					TransparentBlt(hDC, (int)RenderPos.x, (int)RenderPos.y,
						...
						m_Texture->GetDC(),
						(int)m_StateData[(int)EButton_State::Click].Start.x,
						(int)m_StateData[(int)EButton_State::Click].Start.y,
						(int)m_Size.x, (int)m_Size.y,
				...
				else
				{
					TransparentBlt(hDC, (int)RenderPos.x, (int)RenderPos.y,
						(int)m_Size.x, (int)m_Size.y,
						m_Texture->GetDC(),
						(int)m_StateData[(int)EButton_State::Normal].Start.x,
						(int)m_StateData[(int)EButton_State::Normal].Start.y,
						(int)m_Size.x, (int)m_Size.y,
						m_Texture->GetColorKey());
				}
			}
			...
			else
			{
				if (m_Clicked == true)
				{
					BitBlt(hDC, (int)RenderPos.x, (int)RenderPos.y,
						...
						m_Texture->GetDC(),
						(int)m_StateData[(int)EButton_State::Click].Start.x,
						(int)m_StateData[(int)EButton_State::Click].Start.y, SRCCOPY);
				}
				...
				else
				{
					BitBlt(hDC, (int)RenderPos.x, (int)RenderPos.y,
						...
						m_Texture->GetDC(),
						(int)m_StateData[(int)EButton_State::Normal].Start.x,
						(int)m_StateData[(int)EButton_State::Normal].Start.y, SRCCOPY);
				}
			}
		}
