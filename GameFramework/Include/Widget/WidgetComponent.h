...
private:
    ...
    // ≈∏¿Ã∏”
    float   m_WidgetComponentTimer;
    float   m_TimeSinceCreation;
    bool    m_WidgetComponentTimerUse;
...
public:
    ...
    void SetWidgetComponentTimer(float Time)
    {
        m_WidgetComponentTimerUse = true;
        m_WidgetComponentTimer = Time;
    }
