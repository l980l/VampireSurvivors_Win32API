...
bool CGameManager::Init(HINSTANCE hInst)
{
    ...
    m_Brush[(int)EBrush_Type::Khaki] = CreateSolidBrush(RGB(59, 114, 71));


    m_Pen[(int)EBrush_Type::Red] = CreatePen(PS_SOLID, 2, RGB(255, 0, 0));
    m_Pen[(int)EBrush_Type::Green] = CreatePen(PS_SOLID, 2, RGB(0, 255, 0));
    m_Pen[(int)EBrush_Type::Black] = CreatePen(PS_SOLID, 6, RGB(0, 0, 0));
    ...
    m_Pen[(int)EBrush_Type::Khaki] = CreatePen(PS_SOLID, 6, RGB(59, 114, 71));
...
bool CGameManager::Create()
{
    ...
    m_hWnd = CreateWindowW(TEXT("GameFramework"), 
        TEXT("VampireSurvivors"), WS_OVERLAPPEDWINDOW,
